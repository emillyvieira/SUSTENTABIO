      ...
      <div class="row">
        <div class="col-md-6">
          <div class="card mb-3" style="width:700px">
            <div class="row g-0 ">
              <div class="col-md-4">
                <img src="../img/grupo/lare.jpg"  width="260" height="180" class="img-fluid rounded-start" alt="...">
              </div>
              <div class="col-md-8">
                <div class="card-body">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="card mb-3" style="width:700px">
            <div class="row g-0 ">
              <div class="col-md-4">
                <img src="../img/grupo/barbara.jpg"  width="260" height="180" class="img-fluid rounded-start" alt="...">
              </div>
              <div class="col-md-8">
                <div class="card-body">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="card mb-3" style="width:700px">
            <div class="row g-0 ">
              <div class="col-md-4">
                <img src="../img/grupo/dyamine.jpg"  width="260" height="180" class="img-fluid rounded-start" alt="...">
              </div>
              <div class="col-md-8">
                <div class="card-body">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="card mb-3" style="width:700px">
            <div class="row g-0 ">
              <div class="col-md-4">
                <img src="../img/grupo/isabella.jpg"  width="260" height="180" class="img-fluid rounded-start" alt="...">
              </div>
              <div class="col-md-8">
                <div class="card-body">
