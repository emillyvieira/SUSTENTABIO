...
<html lang="pt">
  ...
  <section class="depoimento text-center style">
    <div class="container">
      <div class="row">
        <div class="col-md-3">
          <h3><img src="../img/img/canudos/31.jpg" class="d-block w-100" width="220" height="220">
          </h3>
          <h4>Canudo Estampa Bengala-Doce 17cm</h4>
          <h5>Pct 20 Unidades</h5>
          <h3>R$ 7,90</h3>
          <br/>
        </div>

        <div class="col-md-3">
          <h3><img src="../img/img/canudos/16.jpeg" class="d-block w-100" width="188" height="215">
          </h3>
          <h4>Canudo Papel</h4>
          <h5>Pct 10 Unidades 17cm + 10 Unidades 12cm</h5>
          <h3>R$ 7,90</h3>
          <br/>
        </div>

        <div class="col-md-3">
          <h3><img src="../img/img/canudos/20.jpeg" class="d-block w-100" width="128" height="230">
          </h3>
          <h4>Canudo Estampa Bambu 17cm</h4>
          <h5>Pct 10 Unidades Verdes + 10 Unidades Amarelo</h5>
          <h3>R$ 7,90</h3>
          <br/>
        </div>

        <div class="col-md-3">
          <h3><img src="../img/img/canudos/24.jpg" class="d-block w-100" width="130" height="230">
          </h3>
          <h4>Canudo de Aço</h4>
          <h5>1 Unidade</h5>
          <h3>R$ 19,90</h3>
