...
<html lang="pt">
  ...
  <section class="depoimento text-center style">
    <div class="container">
      <div class="row">
        <div class="col-md-3">
          <h3><img src="../img/img/embalagens/22.png" class="d-block w-100" width="128" height="230">
          </h3>
          <h4>Embalagem Reutilizável</h4>
          <h5>1 Unidade</h5>
          <h3>R$ 15,00</h3>
          <br/>
        </div>
        ...
        <div class="col-md-3">
          <h3><img src="../img/img/embalagens/23.jpg" class="d-block w-100" width="128" height="230">
          </h3>
          <h4>Embalagem Descartável</h4>
          <h5>15 Unidades</h5>
          <h3>R$ 30,00</h3>
          <br/>
        </div>
        ...
        <div class="col-md-3">
          <h3><img src="../img/img/embalagens/25.jpg" class="d-block w-100" width="128" height="230">
          </h3>
          <h4>Kit Embalagens</h4>
          <h5>1 Unidade</h5>
          <h3>R$ 17,90</h3>
          <br/>
        </div>
