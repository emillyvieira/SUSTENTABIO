...
<html lang="pt">
  ...
  <section class="depoimento text-center style">
    <div class="container">
      <div class="row">
        <div class="col-md-3">
          <h3><img src="../img/img/talheres/12.png" class="d-block w-100" width="128" height="230">
          </h3>
          <h4>Garfo Reutilizável</h4>
          <h5>1 Unidade</h5>
          <h3>R$ 10,90</h3>
          <br/>
        </div>
        ...
        <div class="col-md-3">
          <h3><img src="../img/img/talheres/12.jpg" class="d-block w-100" width="128" height="230">
          </h3>
          <h4>Kit 3 Garfos</h4>
          <h5>1 Unidades</h5>
          <h3>R$ 17,50</h3>
        ...
        <div class="col-md-3">
          <h3><img src="../img/img/talheres/13.png" class="d-block w-100" width="128" height="230">
          </h3>
          <h4>Kit 4 Facas</h4>
          <h5>1 Unidade</h5>
          <h3>R$ 17,90</h3>
        ...
        <div class="col-md-3">
          <h3><img src="../img/img/talheres/14.jpeg" class="d-block w-100" width="130" height="230">
          </h3>
          <h4>Kit 2 Garfos Aço</h4>
          <h5>1 Unidades</h5>
          <h3>R$ 16,90</h3>
          <br/>
        </div>
        ...
        <div class="col-md-3">
          <h3><img src="../img/img/talheres/19.jpeg" class="d-block w-100" width="128" height="260">
          </h3>
          <h4>Colher Reutilizável</h4>
          <h5>1 Unidade</h5>
          <h3>R$ 9,90</h3>
          <br/>
        </div>
        ...
        <div class="col-md-3">
          <h3><img src="../img/img/talheres/29.jpg" class="d-block w-100" width="150" height="260">
          </h3>
          <h4>Kit Garfo + Faca + Colher</h4>
          <h5>1 Unidade</h5>
          <h3>R$ 13,90</h3>
          <br/>
        </div>
