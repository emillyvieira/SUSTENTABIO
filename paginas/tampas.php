...
<html lang="pt">
  ...
  <section class="depoimento text-center style">
    <div class="container">
      <div class="row">
        <div class="col-md-3">
          <h3><img src="../img/img/tampas/21.jpg" class="d-block w-100" width="220" height="220">
          </h3>
          <h4>Tampa Embalagem Reutilizável</h4>
          <h5>1 Unidade</h5>
          <h3>R$ 5,90</h3>
          <br/>
        </div>
        ...
        <div class="col-md-3">
          <h3><img src="../img/img/tampas/37.jpg" class="d-block w-100" width="128" height="230">
          </h3>
          <h4>Tampa Copo Reutilizável</h4>
          <h5>1 Unidade</h5>
          <h3>R$ 5,90</h3>
          <br/>
        </div>
